  ...
  <div class="container">
    <div class="row">
      <div class="col-md-5 col-sm-5 wow fadeInLeft" data-wow-delay="400ms">
        <div class="image">
          <img src="images/shop-detail.jpg" alt="Edua" class="img-responsive border-radius">
      ...
      <div class="col-md-7 col-sm-7 shop_info wow fadeInRight" data-wow-delay="400ms">
        <h2 class="heading bottom25">MT8 Online Course<span class="divider-left"></span></h2>
        <h4 class="price_product">$230.00</h4>
        <p class="margin10">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        <p class="bottom25">consectetur id. Aenean sit amet massa eu velit commodo cursus fringilla a tellus. Morbi eros urna, mollis porta feugiat non, ornare eu augue. 
        Sed rhoncus est sit amet diam tempus, et tristique est viverra. Etiam ex tellus, sectur at dapibus id, luctus at odio. Proin mattis congue 
        tristique eu augue. Sed rhoncus est.</p>
      ...
      <div class="shop_tab margin_top">
        ...
        <div class="tab_container">
          <div id="tab1" class="tab_content">
            <p>Proin sagittis feugiat elit finibus pretium. Donec et tortor non purus vulputate tincidunt. Cras congue posuer eros eget egestas. Aenean varius 
            ex ut ex laoreet fermentum.</p>
          ...
          <div class="profile">
            ...
            <div class="profile_text">
              ...
              <p class="margin10">Vivamus bibendum nibh in dolor pharetra, a euismod nulla dignissim. Aenean viverra tincidunt nibh, in imperdiet nunc. Suspendisse eu ante pretium.</p>
            </div>
          </div>
        </div>
        <div class="profile_bg bottom20">
          <div class="profile">
            ...
            <h3 class="heading bottom25">Add Review<span class="divider-left"></span></h3>
            <form class="star_rating bottom15">
                <div class="stars">
    ...
    <div class="clearfix"></div>
      <div class="related_pro padding-top clearfix">
        <div class="col-md-12 wow fadeInDown"><h2 class="heading">Related Product<span class="divider-left"></span></h2></div>
        <div class="col-md-3 col-sm-6 margin_tophalf wow fadeIn" data-wow-delay="300ms">
        <div class="shopping_box">
          <div class="image">
            <img src="images/shop1.jpg" alt="Edua" class="img-responsive border-radius">
            <div class="overlay border_radius">
              <a class="btn_common yellow border_radius btn-cart" href="shop_cart.php">add to cart</a>
            </div>
          </div>
          <div class="shop_content text-center">
            <h4><a href="shop_detail.php" class="title_link">Online Course</a></h4>
            <p>We offer the most complete in the country</p>
            <h4 class="price_product">$230.00</h4>
          </div>
        </div>
      </div>
        <div class="col-md-3 col-sm-6 margin_tophalf wow fadeIn" data-wow-delay="400ms">
        <div class="shopping_box">
          <div class="image">
            <img src="images/shop1.jpg" alt="Edua" class="img-responsive border-radius">
            <div class="overlay border_radius">
        ...
        <div class="col-md-3 col-sm-6 margin_tophalf wow fadeIn" data-wow-delay="500ms">
        <div class="shopping_box">
          <div class="image">
            <img src="images/shop1.jpg" alt="Edua" class="img-responsive border-radius">
            <div class="overlay border_radius">
        ...
        <div class="col-md-3 col-sm-6 margin_tophalf wow fadeIn" data-wow-delay="600ms">
        <div class="shopping_box">
          <div class="image">
            <img src="images/shop1.jpg" alt="Edua" class="img-responsive border-radius">
            <div class="overlay border_radius">
