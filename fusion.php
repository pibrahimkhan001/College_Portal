  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>FUSION</h1>
        <p>A Technical Symposium by department of Chemical Engineering</p>
        <div class="page_nav">
      <span>You are here:</span> <a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>Events | FUSION</span>
      </div>
      </div>
    </div>
  </div>
        ...
        <div class="detail_course">
          <div class="clearfix">
            <ul class="comment pull-left">
              <li><a href="#." class="facebook"><i class="icon-map-pin"></i> chemical dpt. JNTUA</a></li>
              <li><a href="#." class="facebook"><i>start:</i> march 21, 2018 9:15 am</a></li>
              <li><a href="#." class="facebook"><i class="icon-icons20"></i> march 20 and march 21</a></li>
            </ul>
            <a href="#." class="btn_common blue border_radius pull-right"> Join!</a>
          </div>
        </div>
        <h3 class="top30 bottom20">Brief intro about FUSION</h3>
      ...
      <aside class="col-sm-4 wow fadeIn" data-wow-delay="400ms">
        <div class="widget heading_space">
          ...
          <div class="media">
            <a class="media-left" href="#."><img src="images/post1.png" alt="post"></a>
            <div class="media-body">
              <h5 class="bottom5">FUSION co-ordinator</h5>
              <a href="#." class="btn-primary border_radius bottom5">details</a>
