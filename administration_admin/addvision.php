...
<tr>
  <td width="75%" height="35"><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="pagetitle">
    <tr>
      <td height="38" align="left" valign="top" ><div class="welcome"><strong>Add Vision here</strong></div></td>
      </tr>
    </table></td>
</tr>
<tr>
  <td height="35">
					<form action="visionaction.php" method="post">
					  <div class="form-group">
						<label for="Input1">Vision Statement</label>
						<input type="text" class="form-control" id="Input1" placeholder="Add vision Statement" name="name1" required>
					  </div>
