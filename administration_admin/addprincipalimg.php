...
<tr>
  <td width="75%" height="35">
    ...
    <tr>
      ...
      <td height="38" align="left" valign="top" ><div class="welcome"><img src="images/principal_old.jpg" width="80" height="120"></td>
      <td height="38" align="left" valign="top" ><div class="welcome"><strong>Update Principal Image here</strong></div></td>
      </tr>
    </table></td>
</tr>
<tr>
  <td height="35">
					<form action="addprincipalimgaction.php" method="post">
					  <div class="form-group">
						
						<input type="file" class="form-control" id="Input1"  name="image" required>
					  </div>
