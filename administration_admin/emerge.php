  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>EMERGE</h1>
        <p>A Technical Symposium by department of Electronics and Comminication Engineering</p>
        <div class="page_nav">
      <span>You are here:</span> <a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>Events | EMERGE</span>
      </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="detail_course">
          <div class="clearfix">
            <ul class="comment pull-left">
              <li><a href="#." class="facebook"><i class="icon-map-pin"></i> ECE dpt. JNTUA</a></li>
              <li><a href="#." class="facebook"><i>start:</i> march 09, 2018 9:15 am</a></li>
              <li><a href="#." class="facebook"><i class="icon-icons20"></i> march 09 TO march 12</a></li>
            </ul>
            <a href="#." class="btn_common blue border_radius pull-right"> Join!</a>
          </div>
        </div>
        <h3 class="top30 bottom20">Brief intro about EMERGE</h3>
      ...
      <aside class="col-sm-4 wow fadeIn" data-wow-delay="400ms">
        <div class="widget heading_space">
          <h3 class="bottom20">Important personalities</h3>
          <div class="media">
            <a class="media-left" href="#."><img src="images/post1.png" alt="post"></a>
            <div class="media-body">
              <h5 class="bottom5">Our HOD</h5>
              <a href="#." class="btn-primary border_radius bottom5">details</a>
              
              <span class="name">Bhanu Murthy Pavani R</span>
            </div>
          </div>
          <div class="media">
            <a class="media-left" href="#."><img src="images/post1.png" alt="post"></a>
            <div class="media-body">
              <h5 class="bottom5">EMERGE co-ordinator</h5>
              <a href="#." class="btn-primary border_radius bottom5">details</a>
          ...
          <div class="media">
            <a class="media-left" href="#."><img src="images/post1.png" alt="post"></a>
            <div class="media-body">
              <h5 class="bottom5">Student co-ordinator</h5>
              <a href="#." class="btn-primary border_radius bottom5">details</a>
