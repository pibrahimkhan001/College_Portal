...
<tr>
  <td width="75%" height="35"><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="pagetitle">
    <tr>
      <td height="38" align="left" valign="top" ><div class="welcome"><strong>Add Mission here</strong></div></td>
      </tr>
    </table></td>
</tr>
<tr>
  <td height="35">
					<form action="missionaction.php" method="post">
					  <div class="form-group">
						<label for="Input1">Mission Statement</label>
						<input type="text" class="form-control" id="Input1" placeholder="Add mission Statement" name="name1" required>
					  </div>
