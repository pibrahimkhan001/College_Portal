        ...
        <div align="justify">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="89%" valign="top" style="padding-left:5px;"><strong><a href="#"><u>Women Empowerment Cell</u></a></strong> <br /></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="2">
                <strong><a href="#">&nbsp;<u>Foreign Students Cell</a></u> </strong></td>
              </tr>
               <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
               <tr>
              <td colspan="2">
                <strong><a href="scst.php">&nbsp;<u>SC/ST Student Cell</a></u> </strong></td>
              </tr>
          </table>
        </div>
