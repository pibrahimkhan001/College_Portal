  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>RACE</h1>
        <p>A Technical Symposium by department of Civil Engineering</p>
        <div class="page_nav">
      <span>You are here:</span> <a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>Events | Race</span>
      </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8 event wow fadeIn" data-wow-delay="500ms">
        ...
        <div class="detail_course">
          <div class="clearfix">
            <ul class="comment pull-left">
              <li><a href="#." class="facebook"><i class="icon-map-pin"></i> civil dpt. JNTUA</a></li>
        ...
        <h3 class="top30 bottom20">Brief intro about RACE</h3>
        ...
        <div class="widget heading_space">
          ...
          <div class="media">
            ...
            <div class="media-body">
              ...
              <span class="name">Bhanu Murthy Pavani R sir</span>
            </div>
          </div>
          <div class="media">
            <a class="media-left" href="#."><img src="images/post1.png" alt="post"></a>
            <div class="media-body">
              <h5 class="bottom5">RACE co-ordinator</h5>
              <a href="#." class="btn-primary border_radius bottom5">details</a>
