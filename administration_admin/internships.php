...
<tr>
  <td width="75%" height="35"><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="pagetitle">
    <tr><br><br>
      <td height="38" align="left" valign="top" ><div class="welcome"><h3><b>Internships</b></h3></div></td>
      </tr>
    </table></td>
</tr>
<tr>
        ...
        <div align="justify">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="89%" valign="top" style="padding-left:5px;"> <h5>Content Will Be Coming Soon</h5> <br /></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
