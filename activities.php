        ...
        <div align="justify">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="89%" valign="top" style="padding-left:5px;"><strong><a href="ncc.php"><u>National Cadet Corps (NCC)</u></a></strong> <br /></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="2">
                <strong><a href="nss.php">&nbsp;<u>National Service Scheme (NSS)</a></u> </strong></td>
              </tr>
               <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
